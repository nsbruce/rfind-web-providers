...
def load_env()->dict:
    ...
    try:
        ...
        warnings.warn('No .env.local file found in {}. Defaulting to rfind_web.environment.defaults'.format(env_dir))
...
def get_all_defaults()->dict:
    ...
    """
    return {**DEFAULT_SOCKETIO_VARS, **DEFAULT_DATA_VARS, **DEFAULT_S3_VARS, **DEFAULT_SIM_VARS}